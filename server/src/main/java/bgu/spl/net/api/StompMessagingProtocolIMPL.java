...
public class StompMessagingProtocolIMPL implements StompMessagingProtocol<String> {
    ...
    public String process(String message) {   
        ...
        if(command.equals("CONNECT")) {
            ...
            if (!connections.isClientSubscribedToChannel(connectionId, channel)) {
                String errorMsg = "Client is not subscribed to channel: " + channel;
                String errorFrame = createErrorFrame(message, "0", "SEND", errorMsg);
                return errorFrame;
            }
